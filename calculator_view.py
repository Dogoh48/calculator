...
class CalculatorView(tk.Tk):
    ...
    def init_components(self):
        ...
        self.display = tk.Entry(self, textvariable=self.display_var, font=('Arial', 14), justify='right', state='readonly', bg='white', fg='black')
    ...
    def make_keypad(self) -> tk.Frame:
        keys = ['*', '(', ')', 'DEL', 'CLR', '/','7','8','9','sqrt', '+', '4', '5', '6', 'exp', '-', '1', '2', '3', 'abs', '^', '%', 'ln', 'log2', 'log10', '=']
